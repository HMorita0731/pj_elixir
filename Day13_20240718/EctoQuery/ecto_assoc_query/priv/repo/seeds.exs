alias EctoAssocQuery.{Repo,Artist,MusicList,Music,User,PlayList,
PlayListMusic,ActiveUser,DeleteUser}
...
csv
|> Enum.map(fn data ->
  {%MusicList{name: data["music_list_name"],category: data["category"],music_category: data["music_category"]},
  data["artist_name"]}
end)
|> Enum.uniq()
